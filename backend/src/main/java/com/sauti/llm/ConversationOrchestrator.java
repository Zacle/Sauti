...
public class ConversationOrchestrator {
    ...
    private String systemPrompt(
        ...
        return """
                ...
                - If a booking tool returns status `booking_identity_mismatch`, no booking identity was verified and nothing changed. Say only that the supplied phone, appointment date, and exact time could not be verified together; never say which value was wrong. Restart the same three-value sequence from the booking phone.
