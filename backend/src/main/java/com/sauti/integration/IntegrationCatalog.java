...
public class IntegrationCatalog {
    private final List<Entry> entries = List.of(
            ...
            new Entry("calendly", "Calendly", "Calendar",
                    ...
                    List.of("eventTypeUri", "bookingTitle"), List.of()),
            new Entry("telnyx_sms", "SMS", "Messaging",
                    "Send caller-approved SMS from the agent's messaging-enabled Telnyx number. Real calls reuse caller ID; browser tests request a destination.", true, false, false,
                    List.of(), List.of()),
            ...
            new Entry("whatsapp", "WhatsApp", "Messaging",
                    "Send an approved, field-mapped booking template only in the customer's current WhatsApp conversation.", true, false, true,
            ...
            new Entry("google_sheets", "Google Sheets", "Data",
                    "Upsert booked customers, look up rows during calls, and append analysed calls.", true, true, true,
                    List.of("spreadsheetId", "range", "lookupColumn", "customerNameColumn",
                            "customerEmailColumn", "returnColumns", "appendRange", "appendColumns"),
                    List.of()),
