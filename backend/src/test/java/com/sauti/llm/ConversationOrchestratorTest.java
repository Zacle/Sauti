...
class ConversationOrchestratorTest {
    ...
    void loopsThroughToolCallAndReturnsFollowUpResponse() {
        ...
        assertThat(provider.contexts.get(0).systemPrompt())
                ...
                .contains("Existing-booking identity sequence for every agent and business type")
                .contains("never require or ask for a booking number")
                .contains("phone number used for the booking")
                .contains("booking_lookup_name")
                .contains("booking_identity_ambiguous")
                .contains("Never reveal the stored name")
                .contains("booking_identity_mismatch")
                .contains("Never reveal the stored name, candidate appointment times")
