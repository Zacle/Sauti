...
| `TELNYX_AI_MODEL` | No | Telnyx AI Assistant model; defaults to the canonical case-sensitive model ID `moonshotai/Kimi-K2.6` for stronger managed-tool workflow reliability. |
