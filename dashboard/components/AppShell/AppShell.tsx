...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <main className={`console-shell ${["/agents", "/dashboard", "/calls", "/bookings", "/analytics"].includes(pathname) ? "agents-console-shell" : ""} ${pathname === "/dashboard" ? "dashboard-console-shell" : ""} ${pathname === "/calls" ? "calls-console-shell" : ""} ${pathname === "/bookings" ? "bookings-console-shell" : ""} ${pathname === "/analytics" ? "analytics-console-shell" : ""}`}>
